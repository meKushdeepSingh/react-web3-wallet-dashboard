        ...
        <div className="text-center">
          <div className="mb-8">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">
              Your Web3 <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Dashboard</span>
            </h1>
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Connect your wallet to view all your digital assets, NFTs, and transaction history in one beautiful interface.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 text-center hover:bg-white/10 transition-all duration-300">
              ...
              <p className="text-gray-400">Your wallet stays secure. We never store your private keys.</p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 text-center hover:bg-white/10 transition-all duration-300">
              ...
              <p className="text-gray-400">Lightning-fast access to your portfolio and transaction history.</p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 text-center hover:bg-white/10 transition-all duration-300">
              ...
              <p className="text-gray-400">View tokens, NFTs, and transactions across multiple chains.</p>
            </div>
          </div>
        </div>
      </div>
